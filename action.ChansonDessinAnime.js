...
exports.default = function (state) {
	...
	return new Promise(function (resolve, reject) {
		...
		for (var rule in Config.modules.ChansonDessinAnime.rules) {
			var match = (0, _helpers.syntax)(state.sentence, Config.modules.ChansonDessinAnime.rules[rule]); 
			if (match) break;
		}
		...
		setTimeout(function(){ 
			if (state.debug) info('Action ChansonDessinAnime');
			
			state.action = {
				module: 'ChansonDessinAnime',
				command: rule,
				room: room,
